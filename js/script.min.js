...
// --- Mock Data Source for Search Results ---
const siteContent = [
    { title: "Website Development", url: "#website-development", type: "Service" },
    { title: "UI/UX Design", url: "#ui-ux-design", type: "Service" },
    { title: "SEO Optimization", url: "#seo-services", type: "Service" },
    { title: "Digital Marketing", url: "#digital-marketing", type: "Service" },
    { title: "Portfolio Showcase", url: "#portfolio-showcase", type: "Project" },
    { title: "Team", url: "#our-team", type: "About" },
    { title: "Contact Us", url: "#contact", type: "Contact" },
    { title: "Corporate Websites", url: "#corporate-websites", type: "Project" }
];
...
openSearchBtn.addEventListener('click', () => {
    ...
    setTimeout(() => searchInput.focus(), 400); // Focus input after pop-up animation
});
    ...
    if (query.length > 0) {
        ...
        if (filteredResults.length > 0) {
            filteredResults.forEach(item => {
                ...
                resultItem.innerHTML = `${item.title} <span style="color:#999; font-size:0.8em; margin-left:10px;">(${item.type})</span>`;
                searchResultsDropdown.appendChild(resultItem);
            });
            searchResultsDropdown.classList.add('active');
        } else {
            searchResultsDropdown.innerHTML = '<div class="search-results-item" style="color:#888;">No results found.</div>';
            searchResultsDropdown.classList.add('active');
        }
    } else {
        searchResultsDropdown.classList.remove('active');
